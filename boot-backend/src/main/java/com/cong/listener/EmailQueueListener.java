...
public class EmailQueueListener {
  ...
  public void sendMailMessage(Map<String,Object> data) {
    ...
    SimpleMailMessage message = switch (type) {
      case Const.REGISTER_EMAIL ->
        createSimpleMailMessage("Registration Code",
            "Your Registration Code: " + code + "\n" + "\n" + "Enter this code on the registration page to complete your registration, please use the code below", email);
